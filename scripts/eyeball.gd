...
func align_eyeball():
	...
	if (vector_to_player_for_circular_eyeball.length() > length_limit):
		vector_to_player_for_circular_eyeball = vector_to_player_for_circular_eyeball.normalized() * length_limit;
